...
# Cuando messaging.tf agregue el VPC endpoint de SES, este trafico
# se resolvera por PrivateLink sin salir al NAT.
...
# Usado por el endpoint de SES (PrivateLink) que se crea en messaging.tf.
# Declarado aqui para que messaging.tf pueda referenciarlo sin dependencia circular.
