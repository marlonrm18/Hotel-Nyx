...
variable "alb_deletion_protection" {
  description = "Activar protección contra borrado accidental del ALB (recomendado en prod)"
  type        = bool
  default     = false
}
...
variable "rds_instance_class" {
  description = "Clase de instancia RDS (db.t3.medium para dev, db.r6g.large para prod)"
  type        = string
...
variable "cloudfront_web_acl_arn" {
  description = "ARN del WAF WebACL para CloudFront (debe estar en us-east-1). Vacio = sin WAF"
  type        = string
  default     = ""
}
