...
# ─── Atributo personalizado: rol ──────────────────────────────────────────────
# Nota: los custom attributes en Cognito no pueden eliminarse una vez creados;
# se añaden al schema aqui pero solo se modifican en creacion.
