  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "DB_SECRET_ARN", value = aws_secretsmanager_secret.rds.arn },
      ]
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "NODE_ENV", value = var.environment },
        { name = "DOMAIN_NAME", value = var.domain_name },
        # Remitente verificado bajo la identidad SES del dominio (ver ses.tf).
        ...
        # runtime con su task role (GetSecretValue). Ver secrets.tf e iam.tf.
        { name = "MP_SECRET_ARN", value = aws_secretsmanager_secret.mercadopago.arn },
