...
output "alb_listener_https_arn" {
  description = "ARN del listener HTTPS 443 (usado por ECS para registrar targets)"
...
output "cloudfront_distribution_id" {
  description = "ID de la distribucion CloudFront (para invalidaciones de cache: aws cloudfront create-invalidation)"
...
output "cloudfront_hosted_zone_id" {
  description = "Hosted zone ID de CloudFront (siempre Z2FDTNDATAQYW2 — para alias Route 53)"
...
output "ses_vpc_endpoint_dns" {
  description = "DNS privado del endpoint SES (resuelve automaticamente con private_dns_enabled)"
...
output "mercadopago_secret_arn" {
  description = "ARN del secret de Mercado Pago (cargar el valor real por CLI: aws secretsmanager put-secret-value)"
...
output "sns_alerts_arn" {
  description = "ARN del topic SNS de alertas (para suscribir canales adicionales: PagerDuty, Slack, etc.)"
